...
export default function CardScroll() {
 ...
 useEffect(() => {
  ...
  gsap.set(panels, {
    yPercent: (i) => i * 100, // stack cards vertically
  });

  gsap.to(panels, {
    yPercent: (i) => (i - panels.length + 1) * 100,
    ease: "none",
    scrollTrigger: {
        ...
        >
          ...
          {homeWhyUsData.map((data, index) => (
            <div
              ...
              className="wrapper h-screen px-6 sm:px-12 lg:px-14 py-9 sm:py-13 lg:py-14
rounded-[30px] md:rounded-[70px] bg-[#A3FAFE]
