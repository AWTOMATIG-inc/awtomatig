...
import BorderAnimateButton from "../BorderAnimateButton";
export default function DesktopFooter() {
  return (
    <footer className="hidden md:block container relative   min-h-[668px]    mt-6">
      <FadeInSection
      ...
      >
        ...
        <div className="wrapper relative z-9">
          <div className="flex justify-between items-center">
            <h1 className="font-sora text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold bg-[linear-gradient(90deg,#FFFFFF_0%,#02D5E8_100%)] text-transparent bg-clip-text">
              It’s blow your mind! <br />
              Meet Neural Networks
            </h1>

            <BorderAnimateButton name="Get a quote" icon={true} />
          </div>
